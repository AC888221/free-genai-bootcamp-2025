    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        <div className="p-6 space-y-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Putonghua</h2>
            <p className="mt-1 text-3xl text-gray-600 dark:text-gray-300">{word.jiantizi}</p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Pinyin</h2>
            <p className="mt-1 text-xl text-gray-600 dark:text-gray-300">{word.pinyin}</p>
          </div>
